...
//
//	mockgen -source=./handler/user_handler.go -destination=./test/mock/handlers/user_handler_mock.go
//
...
func (mr *MockIUserHandlerMockRecorder) CreateUser(c any) *gomock.Call {
...
func (mr *MockIUserHandlerMockRecorder) DeleteUser(c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUserHandlerMockRecorder) GetAllUsers(c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUserHandlerMockRecorder) GetUser(c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUserHandlerMockRecorder) UpdateUser(c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
