...
//
//	mockgen -source=./service/user_service.go -destination=./test/mock/services/user_service_mock.go
//
...
func (m *MockIUserService) GetAllUsers(ctx context.Context, limit, offset int) ([]entity.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserServiceMockRecorder) GetAllUsers(ctx, limit, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllUsers", reflect.TypeOf((*MockIUserService)(nil).GetAllUsers), ctx, limit, offset)
}
...
func (m *MockIUserService) GetUserCount(ctx context.Context) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserServiceMockRecorder) GetUserCount(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserCount", reflect.TypeOf((*MockIUserService)(nil).GetUserCount), ctx)
}
...
// GetAllUsers mocks base method.
func (m *MockIUserRepository) GetAllUsers(ctx context.Context, limit, offset int) ([]entity.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllUsers", ctx, limit, offset)
	ret0, _ := ret[0].([]entity.User)
	ret1, _ := ret[1].(error)
...
// GetAllUsers indicates an expected call of GetAllUsers.
func (mr *MockIUserRepositoryMockRecorder) GetAllUsers(ctx, limit, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllUsers", reflect.TypeOf((*MockIUserRepository)(nil).GetAllUsers), ctx, limit, offset)
}
...
// GetUserCount mocks base method.
func (m *MockIUserRepository) GetUserCount(ctx context.Context) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserCount", ctx)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
...
// GetUserCount indicates an expected call of GetUserCount.
func (mr *MockIUserRepositoryMockRecorder) GetUserCount(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserCount", reflect.TypeOf((*MockIUserRepository)(nil).GetUserCount), ctx)
}
